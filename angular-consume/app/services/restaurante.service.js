        ...
        execute: function() {
            RestauranteService = (function () {
                ...
                RestauranteService.prototype.getRestaurantes = function () {
                    return this._http.get("http://localhost:8080/api/restaurante").map(function (res) { return res.json(); });
                };
                RestauranteService.prototype.getRestaurante = function (id) {
                    return this._http.get("http://localhost:8080/api/restaurante/" + id).map(function (res) { return res.json(); });
                };
                RestauranteService.prototype.addRestaurante = function (restaurante) {
                    ...
                    console.log(json);
                    console.log(headers);
                    return this._http.post("http://localhost:8080/api/restaurante", params, { headers: headers }).map(function (res) { return res.json; });
                };
